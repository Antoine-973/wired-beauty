...
#[Route('/{_locale<%app.supported_locales%>}/buy-report-request')]
class BuyReportRequestController extends AbstractController
{
    #[Route('/', name: 'app_buy_report_request_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_buy_report_request_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_buy_report_request_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_buy_report_request_edit', methods: ['GET', 'POST'])]
